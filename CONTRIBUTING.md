...
[issues]: https://github.com/partic11e/{{packageName}}/issues/new?template=issue.yaml&title= "Report an issue in partic11e/{{packageName}}"
[feature]: https://github.com/partic11e/{{packageName}}/issues/new?template=feature.md&title= "Request a new feature in partic11e/{{packageName}}"
[documentation]: https://github.com/partic11e/{{packageName}}/labels/type%3A%20docs "Documentation issues in partic11e/{{packageName}}"
[first-issue]: https://github.com/partic11e/{{packageName}}/issues?q=is%3Aopen+is%3Aissue+label%3A%22good+first+issue%22 "Good first issues in partic11e/{{packageName}}"